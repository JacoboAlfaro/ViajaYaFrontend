...
export const environment = {
    apiAuthUrl: `${API_URL.develop}/auth`,
    apiUsuarioUrl: `${API_URL.develop}/usuario`,
    apiReseniaUrl: `${API_URL.develop}/resenia`,
    apiFacturaUrl: `${API_URL.develop}/factura`,
    apihotelUrl: `${API_URL.develop}/hotel`,
    apivueloUrl: `${API_URL.develop}/vuelo`,
    apireservaUrl: `${API_URL.develop}/reserva`,
